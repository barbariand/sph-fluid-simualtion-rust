...
use super::smothing_kernels::spiky_smoothing_kernel_zero_dist;
...
impl SmoothedInteraction {
    ...
    pub fn calculate_pressure(
        ...
        adjacent_particle_indices: &Vec<usize>,
        particles: &[Particle],
    ) -> Vector2D<f32> {
        ...
        for iter_particle_index in adjacent_particle_indices {
            ...
            property_gradient += relative_position.normalise()
                * shared_pressure
                * slope
    ...
    pub fn calculate_density(
        ...
        let mut density = particles[particle_index].mass
            * spiky_smoothing_kernel_zero_dist(self.smoothing_radius);
        for iter_particle_index in adjacent_particle_indices {
